    ...
    sap.ui.controller("sap.ushell.components.homepage.DashboardContent", {
        ...
        _scrollToGroup: function (sChannelId, sEventId, oData) {
            ...
            var oDashboardGroups = document.getElementById("dashboardGroups"),
                iY = oTopElement.getBoundingClientRect().top - oDashboardGroups.getBoundingClientRect().top;

            document.getElementById("sapUshellDashboardPage-cont").scrollTop = iY;
            ...
            if (Device.system.desktop) {
                ...
                if (oData.restoreLastFocusedTile) {
                    ...
                    if (jqGroupContent.length) {
                        sap.ushell.components.ComponentKeysHandler.moveScrollDashboard(jqGroupContent);
                    }
                }
            }
