...
//Move tmpWindow here to resolve ios 13 blank screen
@property (nonatomic, retain) UIWindow *tmpWindow;
...
@interface CDVWKInAppBrowserViewController : UIViewController <CDVScreenOrientationDelegate,WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler, UIPrintInteractionControllerDelegate>{
    @private
    NSString* _userAgent;
