sap.ui.jsview("view.askUsageCollectionPermission", {
    ...
    createContent: function(oController) {
            ...
            // Fixing for issue 1970532296, to avoid there is no padding-top of the first UI Control since the fixing change the webview hight
            var vboxPlaceholder1 = new sap.m.HBox('vbox_placeholder1', { height: sap.ui.Device.os.ios ? "50px": "25px" });
