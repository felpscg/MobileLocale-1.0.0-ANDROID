      ...
      false);
           ...
           var useAfaria = function(successCallback, errorCallback, parameter) {
              ...
              var startProxy = function(successCallback, errorCallback, proxyID, proxyURL, proxyExcetpionList ) {
               ...
               var restartWebView = function(successCallback,errorCallback) {
                    exec(successCallback, errorCallback, "MAFLogonCoreCDVPluginJS","restartWebView", []);
               };
               ...
               var scanFingerprint = function(successCallback, errorCallback) {
                    if(device.platform.toLowerCase()=="android" && device.version && parseInt(device.version)>=6) { //Android 6
