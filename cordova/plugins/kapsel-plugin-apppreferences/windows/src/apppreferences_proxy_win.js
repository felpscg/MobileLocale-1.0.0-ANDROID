...
/*
 * Hide settings page. Settings page should be hidden after the AppPreferences plugin
 * invoking the callback function, because the callback function
 * is registered to cordova when the settings page is showing, and is unregistered 
 * when the plugin invokes the callback function. If the plugin doesn't hide Settings
 * page after calling callback, then the callback will be unregistered and further 
 * invoking to the callback function will not work.
 * */
function hideSettingsPage() {
    console.log('#AppPreferences#hideSettingsPage is called.');
